...
st.markdown("""
Ez az alkalmazás egy betanított Random Forest modell segítségével jósolja meg a gépjárművek CO2-kibocsátását.
""")
st.markdown("---")
...
with col_result:
    ...
    if st.button("Számítás indítása", use_container_width=True):
        ...
        st.info("Adj meg adatokat bal oldalon, majd nyomd meg a gombot!")